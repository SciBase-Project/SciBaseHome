        ...
        */
        ...
        var request_json = {
            "statements": [{
                ...
                "statement": "match (a:Author) return a.Name"
            },{
        ...
        var res = request({
            ...
            if (!err && response.statusCode === 200) {
                ...
                var jsonObj = [];
                if(body.results[3].data){
                    for(i=0;i<body.results[3].data.length; i++){
                        item = {}
                        item ["title"] = body.results[3].data[i].row[1];
                        item ["doi"] = body.results[3].data[i].row[0];
                        item ["month"] = body.results[3].data[i].row[2];
                        item ["year"] = body.results[3].data[i].row[3];
